...
def open_attendance_window():
    ...
    global treeview
    treeview = ttk.Treeview(attendance_window, columns=("Họ tên", "Lớp", "MSSV", "Ngày vào", "Giờ vào", "Trạng thái"), show="headings")
    ...
    # Tạo nút "Xuất file"
    export_button = ttk.Button(attendance_window, text="Xuất file", command=lambda: root.after(10, export_attendance_to_csv))
...
def add_absent_students():
    ...
    for student in students.find():
        if student['mssv'] not in recognized_students:
            ...
            treeview.insert("", "end", values=(student['hoten'], student['lop'], student['mssv'], current_date, None, "Vắng"))
